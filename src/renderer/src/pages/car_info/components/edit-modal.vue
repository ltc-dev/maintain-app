    ...
    <a-form ref="formRef" :model="editFrom" :label-col="{ span: 6 }">
      <a-row :gutter="24">
        <a-col :span="12">
          ...
          >
            <a-input v-model:value.trim="editFrom.car_no" />
          </a-form-item>
        </a-col>
        <a-col :span="12">
          <a-form-item label="车主姓名" name="name">
            <a-input v-model:value.trim="editFrom.name" />
          </a-form-item>
        </a-col>
        <a-col :span="12">
          <a-form-item label="手机号码" name="phone">
            <a-input v-model:value.trim="editFrom.phone" />
          </a-form-item>
        </a-col>
        <a-col :span="12">
          <a-form-item label="轮胎型号" name="tyre_type">
            <a-input v-model:value.trim="editFrom.tyre_type" />
          </a-form-item>
        </a-col>
        <a-col :span="12">
          <a-form-item label="车辆型号" name="car_brand_type">
            <a-input v-model:value.trim="editFrom.car_brand_type" />
          </a-form-item>
        </a-col>
        <a-col :span="12">
          <a-form-item label="车辆颜色" name="car_color">
            <a-input v-model:value.trim="editFrom.car_color" />
          </a-form-item>
        </a-col>
        <a-col :span="24">
          <a-form-item label="家庭住址" name="address" :label-col="{ span: 3 }">
            <a-input v-model:value.trim="editFrom.address" />
          </a-form-item>
        </a-col>
        <a-col :span="24">
